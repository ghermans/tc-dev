...
<div class="panel-group" id="accordion" style="background:#fff;">
                <div class="panel">
                 ...
                 <ul class="nav nav-pills nav-stacked">
								...
								<li><a href="<?php echo base_url("profile"); ?>">Change password</a></li>
								<li class="divider"></li>
 ...
 <?php  foreach ($department as $department_item): ?>
   <li class="<?php echo ($this->uri->segment(3)==$department_item['id'])?"active":''; ?>"><a href="<?php echo base_url("breaktool/manage/")."/";?><?php echo $department_item['id'];?>"><?php echo $department_item['name'];?></a></li>                     
        <?php endforeach; ?> 


								
								<li class="nav-header">Break info</li>
								<li><a href="<?php echo base_url("breaktool/detail");?>">My breaks</a></li>
								<li class="divider"></li>
								<li><a href="javascript:void(0)">Help</a></li>
							</ul>
                        </div>
                    ...
                    <div class="panel-heading">
                      ...
                      ">
                        ...
                        <ul class="nav nav-pills nav-stacked">
								...
								<li class="<?php if($this->uri->segment(1)=="auth" && $this->uri->segment(2)=="roles"){echo "active";}?>"><a href="<?php echo base_url("auth/roles");?>">User Access Roles</a></li>								
								</ul>
                        </div>
                    </div>
                </div>    
                 ...
                 <div class="panel">
                    ...
                    <div id="collapseFive" class="<?php if($this->uri->segment(1)=="settings"){echo "panel-collapse collapse in";} else {echo "panel-collapse collapse" ;}?>">
                       ...
                       <ul class="nav nav-pills nav-stacked">
								...
								<li><a href="<?php echo base_url("settings/license");?>">License</a></li>
